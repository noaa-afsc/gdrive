  ...
  if(isFALSE(googledrive::drive_has_token())) {
    ...
    if(is_cloud) {
      ...
      token_setup_msg <- paste0(
        ...
        "  1: Copy this function to your clipboard:     ", crayon::green("gdrive:::gdrive_gcw_setup()"), "\n\n",
        "  2: \033[1mIn the Google Cloud Workstation\033[22m, go to the 'Files' navigation pane and click 'Upload'. Leave this window open.\n\n",
        "  3: \033[1mOn your local machine\033[22m, paste to run ", crayon::green("gdrive:::gdrive_gcw_setup()"), "\n\n",
